...
public class PalioxisAbility extends Ability {

    private ArchSoupPvP main = ArchSoupPvP.getInstance();

    public PalioxisAbility() {
        super("Palioxis", new ItemBuilder(Material.ENDER_PEARL).name("&bPalioxis").lore(Arrays.asList(
