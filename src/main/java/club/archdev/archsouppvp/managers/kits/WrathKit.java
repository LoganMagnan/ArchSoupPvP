...
public class WrathKit extends Kit {

    private ArchSoupPvP main = ArchSoupPvP.getInstance();

    public WrathKit() {
        super("Wrath", new String[]{
                "&7&oSurround your enemies with",
                "&7&ostrong wither skeletons"
        }, Material.SKULL_ITEM, 1, 2000);
    }
    ...
    public Ability getAbility() {
        return this.main.getAbilityManager().getAbilityByName("Wrath");
    }
