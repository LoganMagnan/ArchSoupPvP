package club.archdev.archsouppvp.utils.menu;
...
public abstract class Menu {
    ...
    public void openMenu(final Player player) {
        ...
        if (autoUpdate && task == null) {
            task = ArchSoupPvP.getInstance().getServer().getScheduler().runTaskTimer(ArchSoupPvP.getInstance(), () -> this.openMenu(player), 0, 20L);
        }
    }
